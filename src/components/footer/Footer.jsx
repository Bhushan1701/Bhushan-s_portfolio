    ...
    return (
        <footer className="footer">
            <div className="footer__container container">
                <h1 className="footer__title">Bhushan</h1>
                ...
                <div className="footer__social">
                    ...
                    <a href="https://www.linkedin.com/in/bhushan-ambekar-251602144/" className="footer__social-link" target="_blank" rel="noreferrer">
