          ...
          <div className="contact__info">
            <div className="contact__card-container">
              <div className="contact__card">
                ...
                <span className="contact__card-data">bhushanambekar65@gmail.com</span>
  
                <a href="mailto:bhushanambekar65@gmail.com" className="contact__button">
                  Write me
...
//                             <span className="contact__card-data">+91 7276903768</span>
